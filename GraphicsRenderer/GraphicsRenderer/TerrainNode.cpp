...
void TerrainNode::BuildVertexLayout()
{
	...
	ThrowIfFailed(_dxframework->GetDevice()->CreateInputLayout(vertexDesc, 4, _vertexShaderByteCode->GetBufferPointer(), _vertexShaderByteCode->GetBufferSize(), _layout.GetAddressOf()));
}
